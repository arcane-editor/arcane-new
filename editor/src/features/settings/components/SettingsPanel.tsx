...
const SETTING_DEFINITIONS: SettingDefinition[] = [
  ...
  { key: 'ai.edits.applyMode', type: 'select', options: ['approve', 'auto'], category: 'AI', label: 'Apply Mode', description: 'Approve (default): review a diff and click Apply before any AI file edit reaches disk. Auto: edits apply immediately (checkpoints still let you restore afterward). Either way, "Apply all this session" on the approval prompt makes an approved plan effectively one-click for the rest of the conversation.' },
