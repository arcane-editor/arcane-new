...
export const SETTING_DEFINITIONS: SettingDefinition[] = [
  ...
  { key: 'ai.specialists.enabled', type: 'boolean', category: 'AI', label: 'Unity Studio Workflow', description: 'Coordinate focused agents, saved editable scene authoring, and input-driven gameplay verification. Requires integration package 0.4.0.' },
