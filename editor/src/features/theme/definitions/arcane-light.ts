...
const arcaneLight: ThemeDefinition = {
  ...
  monaco: {
    ...
    colors: {
      ...
      'editor.selectionBackground': '#A8632A26',
      'editor.selectionHighlightBackground': '#A8632A1A',
      'editor.wordHighlightBackground': '#A8632A14',
      'editor.findMatchBackground': '#A8632A40',
      'editor.findMatchHighlightBackground': '#A8632A1F',
      ...
      'editorSuggestWidget.selectedBackground': '#A8632A1F',
      'editorHoverWidget.background': '#FCFAF3',
      'editorHoverWidget.border': '#E5DECD',
      'editorBracketMatch.background': '#A8632A1F',
      ...
      'scrollbarSlider.background': '#2A26221A',
      'scrollbarSlider.hoverBackground': '#2A262233',
      'scrollbarSlider.activeBackground': '#2A26224C',
      ...
      'editorOverviewRuler.errorForeground': '#9E3A2C99',
      'editorOverviewRuler.warningForeground': '#9E7A1C99',
      'editorOverviewRuler.infoForeground': '#3A628099',
    },
  },
  terminal: {
    background: '#FCFAF3',
