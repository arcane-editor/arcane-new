/**
 * SlashCommandPopover — lists the Claude bridge's advertised slash commands
 * (ACP `available_commands_update`) when the user types `/` at the start of the
 * composer. Reuses the mention-popover styles. Picking inserts `/<name> `.
 */

import { useEffect, useMemo, useRef, useState } from 'react';
import { createPortal } from 'react-dom';
import { SlashSquare } from 'lucide-react';
import type { ClaudeCommand } from '../../../stores/ai';
